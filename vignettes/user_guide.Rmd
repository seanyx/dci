...
load("data/yamaska_riv.RData", verbose = T)
...
```{r}
# Loading sf objects
load("data/yamaska_bar.RData", verbose = T)
load("data/yamaska_outlet.RData", verbose = T)
load("data/yamaska_poi.RData", verbose = T)
